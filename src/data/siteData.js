...
export const experiences = [
  {
    ...
    title: 'The Welcome',
    time: '6:45 PM',
    description: 'Traditional dancers welcome you as you enter The Boma. Once seated you are invited to take part in a hand washing ceremony and to taste the local brew, before beginning your four-course dinner, which has something for everyone.',
  ...
  },
  {
    ...
    title: 'Starters',
    time: '7:00 PM',
    description: 'Your four-course dinner begins with a shared starter platter featuring mouth-watering specialities such as skewered peppered impala, smoked crocodile tail and corn ciabatta and "indumba" bean fritters.',
  ...
  },
  {
    ...
    title: 'Campfire Soup',
    time: '7:15 PM',
    description: 'Make your way to the campfire for the chef\'s freshly made soup of the day served with croutons and homemade bread, plus a selection of vegetarian dishes and a salad bar featuring local organic produce — sweet potato, legumes, nuts and seeds.',
  ...
  },
  {
    ...
    time: '8:00 PM',
    description: 'Enjoy a barbeque buffet including a selection of game meats, beef, borewors, chicken, and our spit roast of the day, served with peanut butter rice or sadza. Try a traditional hunter\'s stew, Zambezi bream or kapenta — halaal diners are catered for.',
  ...
  },
  {
    ...
    time: '8:45 PM',
    description: 'The highlight of the evening — the renowned energetic interactive drumming show, the only one in Zimbabwe. Guests are each handed a djembe drum and given the opportunity to participate by learning a few rhythms, before being invited to the dance floor.',
  ...
  },
  {
    ...
    title: 'Dessert',
    time: '9:15 PM',
    description: 'Round off the feast with something sweet at the dessert bar which has a selection of treats, including malva pudding, koeksisters, chocolate mousse, fruit skewers, creme caramel, chocolate eclairs and apple crumble.',
