...
export const vfscData = {
  ...
  safariClub: {
    ...
    learnMore: [
      { label: 'Activities', path: '/activities' },
      { label: 'Wellness', path: '/activities' },
      { label: 'Helicopter Rides', path: '/activities/helicopter-rides' },
    ],
  ...
  safariLodge: {
    ...
    learnMore: [
      { label: 'Activities', path: '/activities' },
      { label: 'Wellness', path: '/activities' },
      { label: 'Vulture Culture', path: '/activities/vulture-culture' },
    ],
  ...
  aboutUs: {
    ...
    subpages: {
      awards: {
        title: 'Our Awards',
        tagline: 'A legacy of excellence in hospitality, wildlife and sustainable tourism',
        heroImage: `${CDN}/media/zkebcjev/victoria-falls-safari-collection-banners-12.jpg`,
        kicker: 'Recognition',
        introTitle: 'Stars we are proud to wear',
        introImage: `${CDN}/media/eotnzln5/victoria-falls-safari-collection-awards.jpg`,
        intro: [
          'Across the Victoria Falls Safari Collection, recognition has come from the world\u2019s most respected voices in travel and hospitality. These awards reflect not only the quality of our rooms and cuisine, but the dedication of the people who welcome, guide and care for our guests.',
          'From TripAdvisor Certificates of Excellence to the RCI Gold Crown and international accolades earned by Zimbabwe on the global stage, every award is a promise we renew daily \u2014 to make each guest experience unforgettable.',
        ],
        itemsTitle: 'Awards & Accolades',
        itemsSubtitle: 'A selection of the recognition our properties have received',
        items: [
          { name: 'ATTA Member', description: 'Proud member of the African Travel & Tourism Association, committed to responsible travel across the continent.', image: `${CDN}/media/lpkdln1f/atta-logo.png` },
          { name: 'TripAdvisor Certificate of Excellence', description: 'Consistently rated by travellers as among the finest hotels and restaurants in Victoria Falls.', image: `${CDN}/media/2walqtq3/tripadvisor-award.png` },
          { name: "Africa's Eden", description: "Member of Africa's Eden, a network devoted to sustainable tourism and low-impact travel.", image: `${CDN}/media/nz2ngx1k/africas-eden.png` },
          { name: 'RCI Gold Crown', description: 'Lokuthula Lodges has earned one of the most prestigious awards in the vacation-ownership industry.' },
          { name: 'Traveller Review Awards', description: 'Recognised by Booking.com for outstanding guest reviews and consistently excellent experiences.' },
          { name: 'International Recognition', description: 'Zimbabwe itself earned global acclaim at ITB Berlin, spotlighting Victoria Falls as a world-class destination.' },
        ],
        sections: [],
      },
      'meet-the-team': {
        title: 'Meet The Team',
        tagline: 'The passionate people behind our world-class hospitality',
        heroImage: `${CDN}/media/vp4h3lgc/vfsl-meet-the-team-thumbnail.png`,
        kicker: 'Our People',
        introTitle: 'United by a love for Africa',
        introImage: `${CDN}/media/gw5dxxun/victoria-falls-safari-lodge-1.png`,
        intro: [
          ...
          'Many of our team have grown with us for decades, handed skills from one generation to the next, and together create the warm, effortless welcome that defines a stay on the Victoria Falls Safari Lodge estate.',
        ],
        itemsTitle: '',
        itemsSubtitle: '',
        items: [],
        sections: [
          { heading: 'Front of House', body: 'From the moment you arrive, our reception, concierge and reservations teams anticipate every need \u2014 arranging transfers, meals, tours and the small details that turn a good stay into a great one.' },
          { heading: 'Kitchen & Culinary', body: 'Our chefs and kitchen teams craft everything from the legendary four-course Boma feast to elegant restaurant dining, honouring local ingredients and Zimbabwean tradition with every plate.' },
          { heading: 'Guides, Rangers & Conservation', body: 'Our game-drive guides and conservation rangers share the African bush with knowledge, humour and deep respect \u2014 keeping guests safe, inspired and connected to the wild.' },
          { heading: 'Behind the Scenes', body: 'Housekeeping, grounds, maintenance and our dedicated events teams work quietly behind the scenes to keep the estate immaculate, welcoming and always ready to host.' },
        ],
      },
      affiliations: {
        title: 'Global & Local Partners',
        tagline: 'Partnerships that power our hospitality and protect our destination',
        heroImage: `${CDN}/media/fccnpdqq/victoria-falls-safari-collection-thumbnail-9.jpg`,
        kicker: 'Our Partners',
        introTitle: 'Better together',
        introImage: `${CDN}/media/3rkngwi4/victoria-falls-safari-lodge-2025-06-10t135056751.png`,
        intro: [
          'Our commitment to excellence extends far beyond the perimeter of our estate. From travel trade partners who bring guests to us from around the world, to local suppliers who provide the finest ingredients for our kitchens, each partner plays a vital role in the Victoria Falls experience.',
          'Strong partnerships are the foundation of exceptional hospitality, and we are proud to work with organisations that share our commitment to conservation, community and quality.',
        ],
        itemsTitle: 'Affiliations & Partners',
        itemsSubtitle: 'Organisations we proudly work alongside',
        items: [
          { name: 'ATTA', description: 'Member of the African Travel & Tourism Association.', image: `${CDN}/media/lpkdln1f/atta-logo.png` },
          { name: "Africa's Eden", description: 'Sustainability-focused travel network member.', image: `${CDN}/media/nz2ngx1k/africas-eden.png` },
          { name: 'TripAdvisor', description: 'Continually rated among Victoria Falls\u2019 finest.', image: `${CDN}/media/2walqtq3/tripadvisor-award.png` },
          { name: 'Pack for a Purpose', description: 'A global initiative that lets travellers make an impact by carrying essential supplies for local schools and clinics.' },
          { name: 'Victoria Falls Anti-Poaching Unit', description: 'Supporting the conservation of wildlife and the natural environment in the region.' },
          { name: 'Vulture Conservation', description: 'On-site programmes protecting and caring for endangered vultures.' },
        ],
        sections: [],
      },
    },
